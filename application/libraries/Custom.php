...
class Custom{
	...
	function sendEmailSmtp($subject,$body_email,$to,$attachment='',$company,$attachment2='')
    {
		$this->CI =& get_instance();
		$this->CI->load->library('email');
		$this->CI->email->from('no-reply@sse.accordance.co.in',$company);
		$this->CI->email->reply_to('no-reply@sse.accordance.co.in',$company);
		$this->CI->email->to($to);
		//$this->CI->email->cc($cc);

...
class Products_model extends CI_Model
{
    ...
    var $column_order = array(null, 'U.Name', 'U.Description', 'U.Hsn_code', 'U.Unit', 'U.Cost','U.Status'); //set column field database for datatable orderable
    var $column_search = array('U.Name', 'U.Description', 'U.Hsn_code', 'U.Unit', 'U.Cost','U.Status'); //set column field database for datatable searchable 
    ...
    {
        $feilds = array('U.id','U.Name', 'U.Description', 'U.Hsn_code', 'U.Unit', 'U.Cost','U.Status');
        $this->db->select($feilds);
        $this->db->from('products U');

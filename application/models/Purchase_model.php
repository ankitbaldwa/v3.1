...
class Purchase_model extends CI_Model
{
    ...
    {
        $feilds = array('i.id', 'c.FirstName', 'c.LastName', 'u.username', 'i.invoice_no', 'i.invoice_date', 'i.Netammount', 'i.Balance_Amount', 'i.Status');
    ...
    {
        $feilds = array('i.id', 'c.FirstName', 'c.LastName','c.Address','c.City','c.State','c.Country', 'c.Zip','c.GST_No','c.Email','c.Mobile', 'u.username', 'i.State_code','i.invoice_no', 'i.invoice_date','i.Lorry_no','i.waybill','i.Place','i.Gross_amount','i.Additional_amount','i.CGST_percentage','i.SGST_percentage','i.IGST_percentage','i.CESS_value','i.TCS_percentage','i.CGST','i.SGST','i.IGST','i.CESS','i.TCS', 'i.Roundoff','i.Netammount', 'i.Balance_Amount','i.Timestamp', 'i.Status','i.user_id');
        $this->db->select($feilds);
        $this->db->from($table);
        $this->db->join('suppliers c', 'i.Suppliers_id = c.id');
        $this->db->join('users u', 'i.user_id= u.id');
    ...
    {
        $feilds = array('i.id', 'p.Name','i.Hsn_code','i.Qty', 'i.Price','i.Amount');
        $this->db->select($feilds);
        $this->db->from($table);

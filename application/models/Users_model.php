...
class Users_model extends CI_Model
{
    ...
    var $column_order = array(null, 'U.username', 'U.email', 'U.mobile', 'U.status', 'U.role'); //set column field database for datatable orderable
    var $column_search = array('U.mobile', 'U.status', 'U.username', 'U.email', 'U.role'); //set column field database for datatable searchable 
    ...
    {
        $this->db->select('U.id,U.status,U.mobile,U.email,U.username,U.role');

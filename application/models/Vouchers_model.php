...
class Vouchers_model extends CI_Model
{
    ...
    var $column_order = array(null,'id', 'voucher_no', 'voucher_date', 'account_name', 'payment_type', 'paidTo','debit_amount','credit_amount', 'status'); //set column field database for datatable orderable
    var $column_search = array('id','voucher_no', 'voucher_date', 'account_name', 'payment_type', 'paidTo','debit_amount','credit_amount', 'status'); //set column field database for datatable searchable 
    ...
    {
        $feilds = array('id','voucher_no', 'voucher_date', 'account_name', 'payment_type', 'paidTo','debit_amount','credit_amount', 'status');

  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= site_url(CUSTOMERS_VIEW).'/'.enc_dec(1, $id) ?>">Manage Customers Payments</a></li>
                      ...
                      <form class="form-horizontal" method="post" action="<?= $action ?>" id="Payment_form">
                        <div class="row">
                            <div class="col-md-5">
                              ...
                              <div class="form-group">
                                <label for="bill_amt">Outstanding Amount</label>
                                <input readonly type="text" class="form-control" value="<?= ($balance_amount->balance_amount == 0)?$balance_amount->balance_amount:$balance_amount->balance_amount ?>" id="bill_amt" name="billed_amount" value=""/>
                              </div>
                              <div class="form-group">
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <div class="box-footer">
                                ...
                                <a href="<?= site_url(CUSTOMERS_VIEW).'/'.enc_dec(1, $id) ?>"><button class="btn btn-default" type="button">Cancel</button></a>
                              </div>
                              <!-- /.box-footer -->
                            </div>
                          </div>

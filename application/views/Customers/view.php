                  ...
                  <div class="box box-primary">
                     <div class="box-body">
                        <div class="col-md-6">
                           ...
                           <div class="clearfix"></div>
                           <div class="form-group">
                              <label class="col-sm-3 control-label pull-left" for="Zip">Outstanding Balance</label>
                              <div class="col-sm-9 pull-right">
                                 <?= (isset($balance_amount) && $balance_amount->balance_amount != '0')?'<i class="fa fa-inr"></i> '.moneyFormatIndia($balance_amount->balance_amount):'0' ?>
                              </div>
                           </div>
                           <div class="clearfix"></div>
                        </div>
                           ...
                           <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-9">
                                 <div class="box-footer pull-right">
                                    <a href="<?= site_url(CUSTOMERS) ?>"><button class="btn btn-default btn-xs" type="button">Back</button></a>
                                    <a href="<?= site_url(CUSTOMERS_PAYMENTS.'/'.enc_dec(1, $data->id)) ?>"><button class="btn btn-info btn-xs" type="button">Payment</button></a>
                                 </div>
                              </div>
                           </div>
                        </div>
...
<!-- ./wrapper -->
<script>
   var url = "<?= site_url(CUSTOMERS_INVOICE_AJAX.'/'.enc_dec(1, $data->id)) ?>";
   var actioncolumn=7;
</script>
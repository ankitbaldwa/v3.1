...
<head>
  ...
  <title><?= TITLE ?> | Purchase Bill</title>
          ...
          <tr>
            <td>
              <table class="table" style="border: 1px solid black;" cellspacing="0" cellpadding="3" >
                <tbody>
                  <tr>
                    <td rowspan="3" style="width: 270px;border-top: 1px solid black;">
                      <address>
              ...
              <table style="border: 1px solid black;" class="table2" cellspacing="0" cellpadding="3">
                ...
                foreach($invoice_details as $details){ ?>
                    <tr>
                      ...
                      <td><?php $Total_qty += $details->Qty; ?><?= moneyFormatIndia($details->Qty) ?> </td>
              ...
              <table style="border: 0px solid #fff;" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr style="text-align: left;font-size: 11pt;">
                      ...
                      <td style="font-size: 11pt;text-align: right;border-top:1px solid black;border-left:1px solid black;border-right:1px solid black;">
                        <b>For  <?= $data->FirstName ?> <?= $data->LastName ?> &nbsp; &nbsp; &nbsp;</b>
                      </td>
                    </tr>
                    <tr>
                      <td style="font-size: 11pt;text-align: right;border-bottom:1px solid black;border-left:1px solid black;border-right:1px solid black;">

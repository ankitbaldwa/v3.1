  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= site_url(PURCHASE_PAYMENT).'/'.base64_encode($id) ?>">Manage Purchase Bill Payments</a></li>
                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <div class="box-footer">
                                ...
                                <a href="<?= site_url(PURCHASE_PAYMENT).'/'.base64_encode($id) ?>"><button class="btn btn-default" type="button">Cancel</button></a>
                              </div>
                              <!-- /.box-footer -->
                            </div>
                          </div>
...
<!-- ./wrapper -->
<input type="hidden" id="product_url" value="<?= site_url(PURCHASE_PAYMENT_AJAX) ?>">
<script>
    var url = "";
    var actioncolumn="";

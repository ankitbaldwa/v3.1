    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <a class="btn btn-primary btn-xs" href="<?= site_url(PURCHASE_PAYMENT_ADD).'/'.$id ?>" title = "Make Payment"><?= "Make Payment" ?></a> 
            <?php } ?>
            <a class="btn btn-info btn-xs" href="<?= site_url(PURCHASE) ?>" title = "Back"><?= "Back" ?></a> 
            </h3>
				  </div>
				  <!-- /.box-header -->
          <div class="box-body">
...
<!-- ./wrapper -->
<script>
    var url = "<?= site_url(PURCHASE_PAYMENT_AJAX).'/'.$id?>";
    var actioncolumn=8;
</script>

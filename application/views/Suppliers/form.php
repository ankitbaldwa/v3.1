                      ...
                      <form class="form-horizontal" method="post" action="<?= $action ?>">
                       <input type="hidden" id="GSTIN_AJAX" value="<?= site_url(GSTIN_AJAX) ?>" />
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <label class="col-sm-3 control-label" for="DOB">DOB <span class="text text-danger">*</span></label>
                            <div class="col-sm-9">
                          ...
                          <div class="form-group">
                            <div class="col-sm-offset-1 col-sm-11">
                              <div class="box-footer">
                                ...
                                <a href="<?= site_url(SUPPLIERS) ?>"><button class="btn btn-default" type="button">Cancel</button></a>
                              </div>
                              <!-- /.box-footer -->
                            </div>
                          </div>

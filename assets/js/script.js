...
$(function () {
  ...
  $('.view-bill').on("click", function(){
    var way_bill_pdf = $(this).attr('data-waybill-path');
    var title = $(this).attr('data-title');
    var iframe = '<div class="iframe-container"><iframe src="'+way_bill_pdf+'"></iframe></div>'
        $.createModal({
          title: title,
          message: iframe,
          closeButton:true,
